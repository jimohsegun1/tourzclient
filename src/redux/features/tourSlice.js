...
export const createTour = createAsyncThunk(
  ...
  const tourSlice = createSlice({
    ...
    reducers: {
      // Define a reducer for setting the current page.
    ...
    extraReducers: {
      ...
      // Action for fetching a list of tours
      ...
      // Action for fetching a single tour by ID
      ...
      // Action for fetching tours created by a specific user
      ...
      // Action for searching for tours
      ...
      // Action for getting tours by tag
      ...
      // Action for getting related tours
  ...
  // Export the setCurrentPage action and the reducer.
